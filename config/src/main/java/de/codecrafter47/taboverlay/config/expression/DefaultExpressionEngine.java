        ...
        public static class OptionsBuilder {
            ...
            public OptionsBuilder withDefaultTokenReaders() {
                return this
                        ...
                        .tokenReader(new PatternTokenReader(DefaultTokens.STARTS_WITH, "starts_with"))
                        .tokenReader(new PatternTokenReader(DefaultTokens.ENDS_WITH, "-|"))
                        .tokenReader(new PatternTokenReader(DefaultTokens.ENDS_WITH, "ends_with"))
                        .tokenReader(new PatternTokenReader(DefaultTokens.CONTAINS, "<_"))
                        .tokenReader(new PatternTokenReader(DefaultTokens.CONTAINS, "contains"))
